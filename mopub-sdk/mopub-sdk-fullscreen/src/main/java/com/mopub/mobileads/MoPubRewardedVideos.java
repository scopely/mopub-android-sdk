...
public class MoPubRewardedVideos {
    ...
    @ReflectionTarget
    public static void setRewardedVideoCustomEventAdListener(@Nullable RewardedVideoCustomEventAdListener listener) {
        MoPubRewardedVideoManager.setVideoCustomListener(listener);
    }
